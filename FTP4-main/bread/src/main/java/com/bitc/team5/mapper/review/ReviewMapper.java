...
public interface ReviewMapper {
	...
	void storeinsert(ReviewDto userreview);

	List<BoardDto> selectMyReview(String userId) throws Exception;
	...
	ReviewDto selectReview(int idx ) throws Exception;
	//UserDto selectUserDetail(int seq) throws Exception;

	void insertReviewFileList(List<AdminProductFileDto> list);

	// 리뷰사진들고오기
	List<AdminProductFileDto> showReviewList(int idx);
